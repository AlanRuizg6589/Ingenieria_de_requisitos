...
Esto provoca que sea difícil saber qué libros están disponibles, cuáles están prestados y cuándo deben ser devueltos. Además, los usuarios tienen problemas para encontrar rápidamente los libros que buscan y los bibliotecarios deben revisar constantemente los registros para conocer el estado de cada ejemplar. 
...
2. Usuario/Estudiante → Busca libros y solicita préstamos.
...
Para mejorar la seccion de busqueda y organizacion de datos de los libros se usaran las siguientes entidades:
